##[pylyzer] failed /home/dani/advent-of-code-2024/day13/venv/lib/python3.12/site-packages/scipy/optimize/_trustregion_krylov.py 1734628983 3030
.___v_desugar_1 = pyimport "_trustregion"
...
.get_trlib_quadratic_subproblem: |R :> Float|(tol_rel_i: Obj := R, tol_rel_b: Obj := R, disp: Obj := Obj) -> (x: Obj, fun: Obj, jac: Obj, hess: Obj, hessp: Obj) -> Never
.__all__: global::List!({"_minimize_trust_krylov"}, 1)
._minimize_trust_krylov: |T :> {None}, T: Type|(fun: Obj, x0: Obj, args: global::List(T, _: Nat) := global::List(T, _: Nat), jac: Obj := Obj, hess: T := T, hessp: (Obj) -> Never := {None} and (Obj) -> Never, inexact: Bool := {True} and Bool, **trust_region_options := ?V) -> T
